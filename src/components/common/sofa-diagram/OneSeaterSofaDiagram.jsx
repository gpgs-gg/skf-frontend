...
const OneSeaterSofaDiagram = ({ control, product, isView = false }) => {
  ...
  return (
    ...
    "
        ...
        "
          ...
          {/* ================= Width ================= */}
          <div className="absolute top-[52%] md:top-[52%] lg:top-[52%] left-[120px] md:left-[200px] lg:left-[170px] w-[120px]">
            {isView ? (
              <div
                className="
    ...
    "
        ...
        "
          ...
          {/* ================= Height ================= */}
          <div className="absolute top-[20%] left-[-0px] md:left-[-30px] lg:-left-[64px] w-[60px] md:w-[120px]">
            {isView ? (
              <div
                className="
      w-full border rounded-md px-2 py-1
    ...
    "
        ...
        "
          ...
          {/* ================= Depth ================= */}
          <div className="absolute top-[69%] right-[0px] md:right-[-30px] lg:right-[10px] w-[60px] md:w-[120px]">
            {isView ? (
              <div
                className="
      w-full border rounded-md px-2 py-1
