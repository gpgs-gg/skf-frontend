      ...
      <div className="flex justify-center overflow-hidden">
        <div className="relative w-full max-w-[520px]">
          ...
          <img
            ...
            className="w-[300px] h-[400px] md:w-[450px] md:h-[420px]"
          />
          ...
          {/* ================= Height ================= */}
          <div className="absolute top-[34%]  md:-left-[62px] w-[60px] md:w-[120px]">
            <Controller
          ...
          {/* ================= Depth ================= */}
          <div className="absolute top-[74%] right-[0px] md:right-[10px] w-[60px] md:w-[120px]">
            <Controller
