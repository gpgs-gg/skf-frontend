...
const OneSeaterSofaDiagram = ({ control }) => {
  return (
    <div className="w-full">
      ...
      <div className="flex justify-center overflow-hidden">
        <div className="relative w-full max-w-[520px]">
          {/* ================= Notes ================= */}
          <div className="hidden lg:block absolute left-[-180px] top-[62%] md:w-[150px] lg:w-[260px] max-w-md">
            <Controller
          ...
          {/* ================= Sofa Image ================= */}
          <img
            src={IMAGES.OneSeaterSofaDiagram}
            alt="One Seater Sofa Diagram"
            className="w-[300px] h-[400px] md:w-[450px] md:h-[400px]"
          />

          {/* ================= Width ================= */}
          <div className="absolute top-[52%] md:top-[48%] lg:top-[52%] left-[90px] md:left-[170px] w-[120px]">
            <Controller
          ...
          {/* ================= Height ================= */}
          <div className="absolute top-[20%] left-[-2px] md:-left-[64px] w-[60px] md:w-[120px]">
            <Controller
          ...
          {/* ================= Depth ================= */}
          <div className="absolute top-[69%] right-[10px] w-[60px] md:w-[120px]">
            <Controller
...
export default OneSeaterSofaDiagram;
...
//               {/* Width Line */}
//               <div className="absolute top-[185px] left-[25px] w-[145px] border-t border-black">
//                 {/* Left Arrow */}
//                 <div
//                   className="
...
//               {/* Width Input */}
//               <div className="absolute top-[192px] left-[50px]">
//                 <Controller
//                   name="attributes.measurements.0.width"
//                   control={control}
//                   render={({ field }) => (
...
//                 {/* Seat */}
//                 <div className="w-24 h-6 border-x-2 border-b-2 border-gray-700 rounded-b-sm"></div>
...
//           <div className="relative w-[300px] h-[220px]">
//             {/* ================= Sofa ================= */}
//             <div className="absolute top-[40px] left-[70px] w-[96px] h-[100px] border border-2 border-gray-700">
//               {/* Back Cushion Line */}
...
//             {/* ================= Depth Dimension ================= */}
//             <div className="absolute top-[40px] left-[190px] h-[100px] border-l border-black">
//               {/* Top Arrow */}
//               <div
//                 className="
//                 absolute -left-[4px] top-0
...
//               {/* Depth Input */}
//               <div className="absolute top-[36px] left-[18px]">
//                 <Controller
//                   name="attributes.measurements.1.depth"
//                   control={control}
//                   render={({ field }) => (
