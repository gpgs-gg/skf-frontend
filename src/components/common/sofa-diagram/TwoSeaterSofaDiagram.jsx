...
const TwoSeaterSofaDiagram = ({ control, product, isView = false }) => {
    ...
    <div className="w-full ">
      <div className="flex justify-center overflow-hidden">
        <div className="relative w-full max-w-[520px]">
          {/* ================= Notes (Large Screens) ================= */}
          <div className="hidden lg:block absolute left-[-198px] top-[62%] md:w-[150px] lg:w-[260px] max-w-md">
            {isView ? (
              <div
                className="
                  w-full bg-white
          ...
          {/* ================= Width ================= */}
          <div className="absolute top-[52%] left-[110px] md:left-[170px] w-[120px]">
            {isView ? (
              <div
                className="
          ...
          {/* ================= Height ================= */}
          <div className="absolute top-[20%] md:-left-[60px] w-[60px] md:w-[120px]">
            {isView ? (
              <div
                className="
                  w-full border rounded-md px-2 py-1
          ...
          {/* ================= Depth ================= */}
          <div className="absolute top-[71%] right-[6px] md:right-[18px] w-[60px] md:w-[120px]">
            {isView ? (
              <div
                className="
                  w-full border rounded-md px-2 py-1
...
//           {/* ================= Depth ================= */}
//           <div className="absolute top-[71%] right-[20px] w-[60px] md:w-[120px]">
//             <Controller
//               name="attributes.measurements.1.depth"
//               control={control}
//               render={({ field }) => (
