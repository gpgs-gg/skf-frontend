...
const CornerSofaDiagramDisplay = ({ product }) => {
      ...
      <div className="flex justify-center overflow-hidden">
        <div className="relative w-full max-w-[520px]">
          ...
          <img
            ...
            className="w-[300px] h-[400px] mt-2 md:w-[450px] md:h-[400px]"
          />

          {/* ================= Width ================= */}
          <div className="absolute top-[2%] md:top-[0%] left-[90px] md:left-[140px] w-[120px]">
            <div
              className="
...
export default CornerSofaDiagramDisplay;
...
//           {/* ================= Width ================= */}
//           <div className="absolute top-[14%] left-[90px] md:left-[140px] w-[120px]">
