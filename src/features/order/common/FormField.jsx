...
const FormField = ({
  ...
  return (
    <div className="flex flex-col gap-0 pb-2  w-full">
      <label className="text-sm lg:text-lg text-gray-700 font-medium ">
        {label}
      </label>
  ...
  "
                        >
                          {isImage ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-gray-100 text-[9px] font-medium">
                              FILE
                            </div>
                          )}
