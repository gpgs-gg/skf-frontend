...
import { useCurrentUser } from "../auth/services/index";
import {
  SelectStyles,
  InputStyles,
  TextareaStyles,
...
const AddOrder = ({
  ...
  const getLoggedInUser = () => ({
    name: currentUser?.data?.name || "Unknown User",
    empId: currentUser?.data?.empId || "N/A",
  });
...
====================================================== */}
      ...
      <ConfirmModal
        ...
        title="Cancel Order"
        message="You have added products to this order. If you cancel now, all added products will be lost."
